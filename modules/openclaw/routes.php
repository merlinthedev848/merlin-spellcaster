...
if ($routePath === '/openclaw') {
    $title = 'OpenClaw API Integrations';
    $viewPath = __DIR__ . '/pages/ui.php';
    include dirname(dirname(__DIR__)) . '/views/layout.php';
    exit;
}

// Inbound API Gateway for OpenClaw Agents
if (str_starts_with($routePath, '/api/openclaw/')) {
    ...
    if ($routePath === '/api/openclaw/schema.json') {
