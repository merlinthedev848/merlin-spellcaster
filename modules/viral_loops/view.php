...
<div class="grid grid-2">
    ...
    <div class="card" style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <p style="font-size: 13px; color: var(--theme-dark-slate); line-height: 1.6; margin: 0;">
        ...
        <div style="background-color: #fafbfc; border: 1px solid var(--theme-border); border-radius: 8px; padding: 12px; font-family: monospace; font-size: 13px; color: var(--theme-blurple); font-weight: 700; text-align: center;">
            {{referral_link}}
        </div>
        ...
        <div style="background-color: rgba(99,91,255,0.04); border: 1px solid rgba(99,91,255,0.1); border-radius: 8px; padding: 16px;">
            <span style="font-size: 12px; font-weight: 700; color: var(--theme-dark); display: block; margin-bottom: 6px;">💡 Pro Tip: Referral Milestones</span>
            <span style="font-size: 12px; color: var(--theme-dark-slate); line-height: 1.5; display: block;">
            ...
            <table>
                ...
                <tbody>
                    <?php if (empty($topReferrers)): ?>
                        <tr>
                            <td colspan="3" style="text-align: center; color: var(--theme-dark-slate); padding: 40px;">No recommendations logged yet. Send a campaign with {{referral_link}} to begin!</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($topReferrers as $referrer): ?>
                            <tr>
                                <td>
                                    <div style="font-weight: 600; color: var(--theme-dark);"><?= e($referrer['first_name'] . ' ' . $referrer['last_name']) ?: '—' ?></div>
                                    <div style="font-size: 11px; color: var(--theme-dark-slate); font-family: monospace;"><?= e($referrer['email']) ?></div>
                                </td>
                                <td style="font-family: monospace; font-size: 12px; font-weight: 600; color: var(--theme-dark-slate);"><?= e($referrer['referral_code']) ?></td>
