    ...
    <div class="card" style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <form method="post" action="?action=create">
            ...
            <div class="form-group">
                ...
                <span style="font-size: 11px; color: var(--stripe-dark-slate); margin-top: 4px; display: block;">Only alphanumeric characters, hyphens, and underscores allowed.</span>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if (empty($rotators)): ?>
                        <tr>
                            <td colspan="4" style="text-align: center; color: var(--stripe-dark-slate); padding: 40px;">No link rotators defined yet. Create one on the left to start rotating traffic!</td>
                        </tr>
                    <?php else: ?>
                        ...
                        ?>
                            <tr>
                                <td>
                                    <div style="font-weight: 600; color: var(--stripe-dark);"><?= e($r['name']) ?></div>
                                    <div style="font-size: 11px; color: var(--stripe-dark-slate); line-height: 1.4; margin-top: 4px;">
