    ...
    <div class="flex flex-col gap-2 max-w-lg mx-auto">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex-1 flex justify-center">
          <div class="h-10 rounded-lg flex items-center justify-center text-xs font-bold text-white transition-all"
               style="width:<?= $width ?>%;background:<?= $fcolor ?>;min-width:120px;">
