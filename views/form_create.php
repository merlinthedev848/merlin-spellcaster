...
<div class="header-actions">
    <div class="page-title">
        <a href="<?= e(getSetting('app_url')) ?>/forms" style="color: var(--stripe-dark-slate); font-weight: 500; font-size: 13px; text-decoration: none; display: flex; align-items: center; gap: 4px; margin-bottom: 8px;">
...
<div class="grid grid-2">
    ...
    <div class="card" style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="url" id="download_url" name="download_url" value="<?= e($downloadUrlVal) ?>" placeholder="e.g. https://yourwebsite.com/assets/free-ebook.pdf">
                <p style="font-size: 11px; color: var(--stripe-dark-slate); margin-top: 4px;">If provided, successful subscribers will instantly see a download link upon submission.</p>
            </div>
            ...
            <div class="form-group" style="display: flex; flex-direction: column; gap: 10px; margin: 24px 0 32px;">
                <label style="display: inline-flex; align-items: center; gap: 8px; font-weight: 500; font-size: 13px; cursor: pointer;">
                    <input type="checkbox" id="show_name" name="show_name" value="1" style="accent-color: var(--stripe-blurple);" <?= $showNameVal ? 'checked' : '' ?> onchange="updateMock()">
                    Show Name Field (First and Last Name)
                </label>
                
                <label style="display: inline-flex; align-items: center; gap: 8px; font-weight: 500; font-size: 13px; cursor: pointer;">
                    <input type="checkbox" id="require_name" name="require_name" value="1" style="accent-color: var(--stripe-blurple);" <?= $requireNameVal ? 'checked' : '' ?> onchange="updateMock()">
                    Require First Name field to submit
                </label>

                <label style="display: inline-flex; align-items: center; gap: 8px; font-weight: 500; font-size: 13px; cursor: pointer;">
                    <input type="checkbox" name="double_optin" value="1" style="accent-color: var(--stripe-blurple);" <?= $doubleOptinVal ? 'checked' : '' ?>>
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end;">
                ...
                <button type="submit" class="btn btn-primary" style="font-weight: 600;">Save Form Configuration →</button>
            </div>
        </form>
    </div>
    ...
    <div style="display: flex; flex-direction: column; height: 100%;">
        <div class="card" style="flex-grow: 1; display: flex; flex-direction: column; min-height: 480px; justify-content: center; align-items: center; background-color: #fafbfc; border: 1px dashed var(--stripe-border);">
            <div style="width: 100%; max-width: 400px; background-color: white; border-radius: 12px; padding: 32px; box-shadow: 0 10px 30px rgba(0,0,0,0.04); border: 1px solid var(--stripe-border); display: flex; flex-direction: column; text-align: center;">
                <div style="color: var(--stripe-blurple); margin-bottom: 16px;">
                ...
                <h2 id="mock_headline" style="font-size: 20px; font-weight: 800; color: var(--stripe-dark); margin: 0 0 8px; line-height: 1.3;">Subscribe to our newsletter</h2>
                <p id="mock_description" style="color: var(--stripe-dark-slate); font-size: 13px; line-height: 1.6; margin: 0 0 24px;">Join our mailing list to receive standard updates.</p>
                
                <div style="display: flex; flex-direction: column; gap: 12px; text-align: left;">
                    <div id="mock_name_fields" style="display: flex; gap: 10px;">
                        <div style="flex: 1;">
                            <label style="font-size: 11px; font-weight: 600; color: var(--stripe-dark-slate); text-transform: uppercase; display: block; margin-bottom: 6px;">First Name <span id="mock_first_req" style="color: var(--danger); display: none;">*</span></label>
                            <input class="form-control" type="text" placeholder="John" disabled style="margin-bottom: 0;">
                        </div>
                        <div style="flex: 1;">
                            <label style="font-size: 11px; font-weight: 600; color: var(--stripe-dark-slate); text-transform: uppercase; display: block; margin-bottom: 6px;">Last Name</label>
                            <input class="form-control" type="text" placeholder="Doe" disabled style="margin-bottom: 0;">
                        </div>
                    </div>
                    
                    <div>
                        <label style="font-size: 11px; font-weight: 600; color: var(--stripe-dark-slate); text-transform: uppercase; display: block; margin-bottom: 6px;">Email Address *</label>
            ...
            <div style="margin-top: 16px; font-size: 11px; color: var(--stripe-dark-slate); font-weight: 500;">Live Workspace Editor Preview</div>
        </div>
    </div>
</div>
